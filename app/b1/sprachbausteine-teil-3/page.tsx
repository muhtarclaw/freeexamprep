...
export default function SprachT3Page() {
  const quizList = getQuizzesByType('sprachbausteine-t3', 'B1');
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[color:var(--foreground)] font-serif">Sprachbausteine Teil 3</h1>
        ...
        <div className="editorial-card rounded-[2rem] p-2">
          {quizList.map((quiz, i) => (
            <Link key={quiz.id} href={`/quiz/sprachbausteine-t3/${quiz.id}`}
