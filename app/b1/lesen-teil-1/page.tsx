...
const quizList = getQuizzesByType('lesen-t1', 'B1');

export default function LesenT1Page() {
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[color:var(--foreground)] font-serif">Lesen Teil 1</h1>
            <p className="mt-1 text-[color:var(--ink-soft)]">Ordnen Sie jeden Text einer der zehn Antworten zu.</p>
          </div>
        </div>
        ...
        <div className="editorial-card rounded-[2rem] p-2">
          {quizList.map((quiz, i) => (
            ...
            >
              ...
              <span className="text-sm font-medium text-[color:var(--brand)] group-hover:translate-x-1 transition">
                Quiz {quiz.id} →
              </span>
            </Link>
          ))}
